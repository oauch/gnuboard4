...
{ 
	...
	if (file_exists($thumb)){
		$img = "<img src='$thumb' border=0 width='150' height='150'>";
	}
	...
	echo "<tr valign='top'>";
	echo "<td style='border:solid 1px #EFEFEF; width:150; height:150;' align='center'>";
	echo "<table width='150' height='150' cellpadding='0' cellspacing='0' border='0'><td align='center'>{$view_href}{$img}</a></td></tr></table>";
	echo "</td></tr>";
