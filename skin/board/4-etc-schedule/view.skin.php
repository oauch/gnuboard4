...
<div style="clear:both; height:30px;">
    ...
    <? echo "<a href=\"$list_href&mode=$mode\"><img src='$board_skin_path/img/btn_list.gif' border='0' align='absmiddle'></a> "; ?>
    <? if ($update_href) { echo "<a href=\"$update_href&mode=$mode\"><img src='$board_skin_path/img/btn_modify.gif' border='0' align='absmiddle'></a> "; } ?>
    <? if ($delete_href) { echo "<a href=\"$delete_href\"><img src='$board_skin_path/img/btn_delete.gif' border='0' align='absmiddle'></a> "; } ?>
    <? if ($reply_href) { echo "<a href=\"$reply_href&mode=$mode\"><img src='$board_skin_path/img/btn_reply.gif' border='0' align='absmiddle'></a> "; } ?>
    <? if ($write_href) { echo "<a href=\"$write_href&mode=$mode\"><img src='$board_skin_path/img/btn_write.gif' border='0' align='absmiddle'></a> "; } ?>
    <?
...
?>
        ...
        &nbsp;일정 :
        <?=$from_date?> <?=$view[wr_6]?> <? if($from_date != $to_date) echo"~ $to_date $view[wr_7]";?><br>
        &nbsp;장소 :
        <?=$view[wr_2]?><br>
        </div>
        <div style="float:right;">
