    ...
    <td width='100%'>
        ...
        <tr>
            <td valign=top>
                ...
                <div style="float:right; _margin-top:5px;">
                <? if ($admin_href) { ?><? if ($is_ip_view) { echo "&nbsp;<span style=\"color:#B2B2B2; font-size:11px;\">{$list[$i][ip]}</span>"; } ?><? } ?>
...
<tr>
    ...
    <td width=85 align=center>
        <div><input type=submit accesskey='s' value='Comment' class="btn_coment"></div>
    </td>
</tr>
</table>
</form>
