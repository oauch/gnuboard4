...
<table width="<?=$width?>" align="center" cellpadding="0" cellspcing="0" style="padding-left:10px;"><tr><td>
...
{ 
	...
	if (file_exists($thumb)){
		$img = "<img src='$thumb' border=0 width='312' height='112'>";
	}
	...
	echo "<tr valign='top'>";
	echo "<td style='border:solid 1px #dedede; width:312; height:112;' align='center'>";
	echo "<table width='312' height='112' cellpadding='0' cellspacing='0' border='0'><td align='center'><a href='$content' target='_blank'>{$img}</a></td></tr></table>";
	echo "</td></tr>";
	echo "<tr align=center><td id='board_list'><a href='$content' target='_blank'>{$list[$i][subject]}</a></td></tr>";
	if ($is_checkbox) {
	...
	if ($admin_href) {
		echo "<tr><td align=center><a href='{$list[$i][href]}' style='font-size:10pt; font-weight:bold; color:#adadad;'>[수정]</a></td></tr>";
	}
