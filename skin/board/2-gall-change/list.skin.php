...
{ 
	...
	echo "<div id='board_gall_img_post'><a href='{$list[$i][href]}'><img src='$photo_view' border=0 id='board_gall_img_width'></a><span id='board_gall_img_txt'><a href='{$list[$i][href]}'><b>제목 - {$list[$i][subject]}</b></a></span></div>";
