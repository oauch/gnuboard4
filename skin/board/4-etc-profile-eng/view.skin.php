...
<table width=<?=$width?> border="0" cellspacing="0" cellpadding="0">
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0" class="prf-table" >
  ...
  <div class="bg-white"><div class="prf-title">Achievement</div><?=nl2br($view[wr_3])?></div>
  <div class="bg-grey"><div class="prf-title">Career</div><?=nl2br($view[wr_4])?></div>
 <div class="bg-white"><div class="prf-title">Etc</div><?=nl2br($view[wr_5])?></div> 
 </td></tr>
  </table>
 </td>
  </tr>
