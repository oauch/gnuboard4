...
{ 
	...
	if (file_exists($thumb)){
		$img = "<img src='$thumb' border=0 width='190' height='150'>";
	}
	...
	echo "<tr valign='top'>";
	echo "<td style='border:solid 1px #EFEFEF; width:190; height:150;' align='center'>";
	echo "<table width='190' height='150' cellpadding='0' cellspacing='0' border='0'><td align='center'>{$view_href}{$img}</a></td></tr></table>";
	echo "</td></tr>";
	echo "<tr align=center><td id='board_list'><a href='{$list[$i][href]}'>{$list[$i][subject]}</a></td></tr>";
	if ($is_checkbox) {
