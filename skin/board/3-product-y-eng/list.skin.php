...
{ 
	...
	echo "  </tr>";
	echo "  <tr>";
	echo "    <td class='board_list'>Model</td>";
	echo "    <td>{$list[$i][wr_2]}</td>";
	echo "  </tr>";
	echo "  <tr>";
	echo "    <td class='board_list'>Size</td>";
	echo "    <td>{$list[$i][wr_3]}</td>";
	echo "  </tr>";
	echo "  <tr>";
	echo "    <td class='board_list'>Weight</td>";
...
<div style="text-align:center; line-height:30px; clear:both; margin:5px 0 10px 0; padding:5px 0; font-family:gulim;">
    ...
    <div class="board_search" style="padding-top:10px;">
        ...
        <select name="sfl">
            ...
            <option value="wr_subject||wr_content">Product+Content</option>
