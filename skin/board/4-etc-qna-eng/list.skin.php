...
<!-- 게시판 목록 시작 -->
<table width="<?=$width?>" align="center" cellpadding="0" cellspacing="0"><tr><td class="botx">
...
<br><br>
    ...
    <tr class="bg<?=$bg?>"> 
        ...
        <td class="subject" >
            ...
            if ($is_category && $list[$i][ca_name]) { 
                echo "<span class=small><font color=gray>[<a href='{$list[$i][ca_name_href]}'>{$list[$i][ca_name]}</a>]</font></span> ";
						...
						/**/
            if ($list[$i][is_notice])
                echo "<a href='{$list[$i][href]}'>{$list[$i][subject]}<span class='notice'></span></a>";
            else
        ...
        if ($list[$i][is_notice])
                ...
                if ($list[$i][comment_cnt]) 
		echo "<img src='$board_skin_path/img/btn_complete.png'>";
		else
		echo "<img src='$board_skin_path/img/btn_wait.png'>";
        ?>
 ...
 <!-- 검색 --><br><br>
    <div class="board_search">
        ...
        <input type="submit" accesskey='s' value='Search' class="btn_search">
