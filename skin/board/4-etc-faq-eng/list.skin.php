...
<!-- 검색 -->
   ...
   <? if ($write_href) { ?><div id=basicclas01 style='float:right; padding-bottom:10px;'><a href='<?=$admin_href?>' id="board_button2">Admin</a></div><? } ?>
  ...
  <tr>
    <td>
	    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb_faq">
	      <tr>
	      	<td align="left" class="faq-title"><b>FAQ</b>
This is a frequently asked question.
Please search for any questions first! </td>
			...
			<table cellpadding="0" cellspacing="0">
			    <tr>
			        ...
			        <td><input type="submit" value="Search" accesskey="s" class="btn_search">
...
echo " <tr>";
echo "<td></td>";
echo "<td style='padding:100px 0 60px 0;'><div align=center><br>There are no posts.</div></td>";
echo "<td></td>";
echo "</tr>";
echo "<tr>";
echo "<td></td>";
