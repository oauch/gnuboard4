...
<table width=700 cellspacing=0 cellspacing=0 align=center>
<tr><td height="1" bgcolor="#CCCCCC"><!--line--></td></tr>
<tr><td align=center>
 <? if ($config[cf_use_jumin]) { // 주민등록번호를 사용한다면 ?>
    ...
    <table width="100%" cellpadding="4" cellspacing="0">
        ...
        <tr> 
            <td align="center" valign="top" class="loadtext"><textarea style="width: 98%" rows=10 readonly class=loadtext><?=get_text($config[cf_stipulation])?></textarea></td>
        </tr>
        <tr> 
            <td height=40>
    ...
    <tr><td height="1" bgcolor="#CCCCCC"><!--line--></td></tr>
        ...
        <tr> 
            <td align="center" valign="top"><textarea style="width: 98%" rows=10 readonly class=loadtext><?=get_text($config[cf_privacy])?></textarea></td>
        </tr>
        <tr> 
            <td height=40>
