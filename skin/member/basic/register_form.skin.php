...
<style type="text/css">
<!--
.m_title    { BACKGROUND-COLOR: #ffffff; PADDING-LEFT: 15px; PADDING-top: 5px; PADDING-BOTTOM: 5px; }
...
<table cellspacing=1 cellpadding=0 width=100%>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td class=m_padding><input type=checkbox name=mb_open value='1' <?=($w=='' || $member[mb_open])?'checked':'';?>>
      ´Ù¸¥ºÐµéÀÌ ³ªÀÇ Á¤º¸¸¦ º¼ ¼ö ÀÖµµ·Ï ÇÕ´Ï´Ù. <br>
      &nbsp;&nbsp;&nbsp;&nbsp; Á¤º¸°ø°³¸¦ ¹Ù²Ù½Ã¸é ¾ÕÀ¸·Î
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td class=m_padding> Á¤º¸°ø°³´Â ¼öÁ¤ÈÄ
      ...
      ÀÌ·¸°Ô ÇÏ´Â ÀÌÀ¯´Â ÀæÀº Á¤º¸°ø°³ ¼öÁ¤À¸·Î ÀÎÇÏ¿© ÂÊÁö¸¦ º¸³½ ÈÄ ¹ÞÁö ¾Ê´Â °æ¿ì¸¦ ¸·±â À§ÇØ¼­ ÀÔ´Ï´Ù. </td>
  </tr>
  <? } ?>
