...
<tr>
    <td class="admin_basic_board_writetd">홈페이지 제목</td>
    <td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">쪽지보낼시 차감 포인트</td>
...
<tr>
    ...
    <td colspan=3><input type=text name='cf_cut_name' value='<?=$config[cf_cut_name]?>' size=2> 자리만 표시
...
<tr>
    <td class="admin_basic_board_writetd">최근게시물 스킨</td>
    ...
    <td class="admin_basic_board_writetd">최근게시물 라인수</td>
    <td><input type=text name='cf_new_rows' value='<?=$config[cf_new_rows]?>' size=5> 라인
        <?=help("목록 한페이지당 라인수")?></td>
</tr>
<tr>
    <td class="admin_basic_board_writetd">검색 스킨</td>
...
<tr>
    <td class="admin_basic_board_writetd">접속자 스킨</td>
...
<tr>
    <td class="admin_basic_board_writetd">플래쉬 업로드 확장자</td>
    <td colspan=3><input type=text name='cf_flash_extension' size='80' itemname='플래쉬 업로드 확장자' value='<?=$config[cf_flash_extension]?>'>
        <?=help("게시판 글작성시 플래쉬 파일 업로드 가능 확장자. | 로 구분")?></td>
</tr>
<tr>
    <td class="admin_basic_board_writetd">동영상 업로드 확장자</td>
    <td colspan=3><input type=text name='cf_movie_extension' size='80' itemname='동영상 업로드 확장자' value='<?=$config[cf_movie_extension]?>'>
...
<tr>
    <td class="admin_basic_board_writetd">홈페이지 입력</td>
    <td>
    ...
    <td class="admin_basic_board_writetd">주소 입력</td>
    <td>
...
<tr>
    <td class="admin_basic_board_writetd">전화번호 입력</td>
    <td>
    ...
    <td class="admin_basic_board_writetd">핸드폰 입력</td>
    <td>
...
<tr>
    <td class="admin_basic_board_writetd">서명 입력</td>
    <td>
    ...
    <td class="admin_basic_board_writetd">자기소개 입력</td>
    <td>
...
<tr>
    <td class="admin_basic_board_writetd">회원아이콘 사용</td>
    <td>
...
<tr>
    <td class="admin_basic_board_writetd">추천인제도 사용</td>
    <td><input type='checkbox' name='cf_use_recommend' value='1' <?=$config[cf_use_recommend]?'checked':'';?>> 사용</td>
    <td class="admin_basic_board_writetd">추천인 포인트</td>
...
<tr class="admin_basic_board_writetd">
    <td><span>게시판 글 작성시</span></td>
</tr>
<tr>
    <td class="admin_basic_board_writetd">최고관리자 메일발송</td>
...
<tr>
    <td class="admin_basic_board_writetd">그룹관리자 메일발송</td>
...
<tr>
    <td class="admin_basic_board_writetd">게시판관리자 메일발송</td>
...
<tr>
    <td class="admin_basic_board_writetd">회원님께 메일발송</td>
...
<tr>
    <td colspan=4 align=left><div class="admin_title01">여분필드</div> <!-- ?=subtitle("여분 필드")? --></td>
</tr>
...
<tr>
    ...
    <td><input type='text' style='width:99%;' name=cf_<?=$i?> value='<?=$config["cf_$i"]?>' title='여분필드 <?=$i?> 설정값'></td>
    <td><input type=text name='cf_<?=$k?>_subj' value='<?=get_text($config["cf_{$k}_subj"])?>' title='여분필드 <?=$k?> 제목' style='text-align:right;font-weight:bold;' size=15></td>
    <td><input type='text' style='width:99%;' name=cf_<?=$k?> value='<?=$config["cf_$k"]?>' title='여분필드 <?=$k?> 설정값'></td>
</tr>
<? } ?>
