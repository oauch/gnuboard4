...
<!-- 
// 2016.12.13 이전 목록은 board_form-original.php 에 있습니다. 
// 기본설정부터 회원가입설정등은  board_form-original.php를 참조부탁드리며 
// 사용하는 부분만 살려놓았습니다. 
 -->
...
<colgroup width=75%>
<tr>
    <td colspan=3 align=left><div class="admin_title01"><?=$html_title?></div></td>
</tr>

<tr>
    <td></td>
    <td class="admin_basic_board_writetd">TABLE</td>
    <td><input type=text name=bo_table size=30 maxlength=20 <?=$bo_table_attr?> itemname='TABLE' value='<?=$board[bo_table] ?>'>
        <? 
        if ($w == "") 
...
<tr>
    <td></td>
    <td class="admin_basic_board_writetd">그룹</td>
    <td>
...
<tr>
    <td></td>
    <td class="admin_basic_board_writetd">게시판 제목</td>
    <td>
        <input type=text name=bo_subject size=60 maxlength=120 required itemname='게시판 제목' value='<?=get_text($board[bo_subject])?>'>
    </td>
</tr>
<tr>
    <td></td>
    <td class="admin_basic_board_writetd">상단 이미지</td>
    <td>
        <input type=file name=bo_image_head size=60>
        <?
...
<tr>
    <td></td>
    <td class="admin_basic_board_writetd">하단 이미지</td>
    <td>
        <input type=file name=bo_image_tail size=60>
        <? 
...
<tr>
    <td></td>
    <td class="admin_basic_board_writetd">카운트 조정</td>
    <td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">게시판 관리자</td>
    <td><input type=text name=bo_admin maxlength=20 value='<?=$board[bo_admin]?>'></td>
</tr>


<tr>
    <td><input type=checkbox name=chk_list_level value=1></td>
    <td class="admin_basic_board_writetd">목록보기 권한</td>
    <td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">글읽기 권한</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">글쓰기 권한</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">글답변 권한</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">코멘트쓰기 권한</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">링크 권한</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">업로드 권한</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">다운로드 권한</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">HTML 쓰기 권한</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">트랙백쓰기 권한</td>
    <td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">원글 수정 불가</td>
    <td>코멘트 <input type=text name=bo_count_modify size=3 required numeric itemname='원글 수정 불가 코멘트수' value='<?=$board[bo_count_modify]?>'>개 이상 달리면 수정불가</td>
</tr>
<tr>
    <td><input type=checkbox name=chk_count_delete value=1></td>
    <td class="admin_basic_board_writetd">원글 삭제 불가</td>
    <td>코멘트 <input type=text name=bo_count_delete size=3 required numeric itemname='원글 삭제 불가 코멘트수' value='<?=$board[bo_count_delete]?>'>개 이상 달리면 삭제불가</td>
</tr>

<tr>
    <td></td>
    <td class="admin_basic_board_writetd">포인트 설정</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">글읽기 포인트</td>
    <td><input type=text name=bo_read_point size=10 required itemname='글읽기 포인트' value='<?=$board[bo_read_point]?>'></td>
</tr>
<tr>
    <td><input type=checkbox name=chk_write_point value=1></td>
    <td class="admin_basic_board_writetd">글쓰기 포인트</td>
    <td><input type=text name=bo_write_point size=10 required itemname='글쓰기 포인트' value='<?=$board[bo_write_point]?>'></td>
</tr>
<tr>
    <td><input type=checkbox name=chk_comment_point value=1></td>
    <td class="admin_basic_board_writetd">코멘트쓰기 포인트</td>
    <td><input type=text name=bo_comment_point size=10 required itemname='답변, 코멘트쓰기 포인트' value='<?=$board[bo_comment_point]?>'></td>
</tr>
<tr>
    <td><input type=checkbox name=chk_download_point value=1></td>
    <td class="admin_basic_board_writetd">다운로드 포인트</td>
    <td><input type=text name=bo_download_point size=10 required itemname='다운로드 포인트' value='<?=$board[bo_download_point]?>'></td>
</tr>
...
<tr>
    ...
    <td><input type=text name=bo_category_list style='width:80%;' value='<?=get_text($board[bo_category_list])?>'>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">글쓴이 사이드뷰</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">파일 설명 사용</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">코멘트 새창 사용</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">비밀글 사용</td>
    <td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">DHTML 에디터 사용</td>
    <td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">RSS 보이기 사용</td>
    <td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">추천 사용</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">비추천 사용</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">이름(실명) 사용</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">서명보이기 사용</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">IP 보이기 사용</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">트랙백 사용</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">목록에서 내용 사용</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">전체목록보이기 사용</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">스킨 디렉토리</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">가로 이미지수</td>
    <td><input type=text name=bo_gallery_cols size=10 required itemname='가로 이미지수' value='<?=$board[bo_gallery_cols]?>'>
        <?=help("갤러리 형식의 게시판 목록에서 이미지를 한줄에 몇장씩 보여줄것인지를 설정하는 값")?></td>
</tr>
<tr>
    <td><input type=checkbox name=chk_table_width value=1></td>
    <td class="admin_basic_board_writetd">게시판 테이블 폭</td>
    <td><input type=text name=bo_table_width size=10 required itemname='게시판 테이블 폭' value='<?=$board[bo_table_width]?>'> 100 이하는 %</td>
</tr>
<tr>
    <td><input type=checkbox name=chk_page_rows value=1></td>
    <td class="admin_basic_board_writetd">페이지당 목록 수</td>
    <td><input type=text name=bo_page_rows size=10 required itemname='페이지당 목록 수' value='<?=$board[bo_page_rows]?>'></td>
</tr>
<tr>
    <td><input type=checkbox name=chk_subject_len value=1></td>
    <td class="admin_basic_board_writetd">제목 길이</td>
    <td><input type=text name=bo_subject_len size=10 required itemname='제목 길이' value='<?=$board[bo_subject_len]?>'> 목록에서의 제목 글자수. 잘리는 글은 … 로 표시</td>
</tr>
<tr>
    <td><input type=checkbox name=chk_new value=1></td>
    <td class="admin_basic_board_writetd">new 이미지</td>
    <td><input type=text name=bo_new size=10 required itemname='new 이미지' value='<?=$board[bo_new]?>'> 글 입력후 new 이미지를 출력하는 시간</td>
</tr>
<tr>
    <td><input type=checkbox name=chk_hot value=1></td>
    <td class="admin_basic_board_writetd">hot 이미지</td>
    <td><input type=text name=bo_hot size=10 required itemname='hot 이미지' value='<?=$board[bo_hot]?>'> 조회수가 설정값 이상이면 hot 이미지 출력</td>
</tr>
<tr>
    <td><input type=checkbox name=chk_image_width value=1></td>
    <td class="admin_basic_board_writetd">이미지 폭 크기</td>
    <td><input type=text name=bo_image_width size=10 required itemname='이미지 폭 크기' value='<?=$board[bo_image_width]?>'> 픽셀 (게시판에서 출력되는 이미지의 폭 크기)</td>
</tr>
<tr>
    <td><input type=checkbox name=chk_reply_order value=1></td>
    <td class="admin_basic_board_writetd">답변 달기</td>
    <td>
...
<tr>
    ...
    <td>사용금지 태그</td>
    <td><input type=text name=bo_disable_tags style='width:80%;' value='<?=get_text($board[bo_disable_tags])?>'>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">리스트 정렬 필드</td>
    <td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">최소 글수 제한</td>
    <td><input type=text name=bo_write_min size=5 numeric value='<?=$board[bo_write_min]?>'>
        (글 입력시 최소 글자수를 설정. 0을 입력하면 검사하지 않음)</td>
</tr>
<tr>
    <td><input type=checkbox name=chk_write_max value=1></td>
    <td class="admin_basic_board_writetd">최대 글수 제한</td>
    <td><input type=text name=bo_write_max size=5 numeric value='<?=$board[bo_write_max]?>'>
        (글 입력시 최대 글자수를 설정. 0을 입력하면 검사하지 않음)</td>
</tr>
<tr>
    <td><input type=checkbox name=chk_comment_min value=1></td>
    <td class="admin_basic_board_writetd">최소 코멘트수 제한</td>
    <td><input type=text name=bo_comment_min size=5 numeric value='<?=$board[bo_comment_min]?>'>
        (코멘트 입력시 최소 글자수, 최대 글자수를 설정. 0을 입력하면 검사하지 않음)</td>
</tr>
<tr>
    <td><input type=checkbox name=chk_comment_max value=1></td>
    <td class="admin_basic_board_writetd">최대 코멘트수 제한</td>
    <td><input type=text name=bo_comment_max size=5 numeric value='<?=$board[bo_comment_max]?>'>
        (코멘트 입력시 최소 글자수, 최대 글자수를 설정. 0을 입력하면 검사하지 않음)</td>
</tr>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">파일 업로드 갯수</td>
    <td><input type=text name=bo_upload_count size=10 required itemname='파일 업로드 갯수' value='<?=$board[bo_upload_count]?>'> 게시물 한건당 업로드 할 수 있는 파일의 최대 개수 (0 이면 제한 없음)</td>
</tr>
<?
...
<tr>
    ...
    <td class="admin_basic_board_writetd">파일 업로드 용량</td>
    <td>업로드 파일 한개당 <input type=text name=bo_upload_size size=10 required itemname='파일 업로드 용량' value='<?=$board[bo_upload_size]?>'> bytes 이하 (최대 <?=ini_get("upload_max_filesize")?> 이하) <?=help("1 MB = 1,024,768 bytes")?></td>
</tr>


<tr>
    <td><input type=checkbox name=chk_include_head value=1></td>
    <td class="admin_basic_board_writetd">상단 파일 경로</td>
    <td><input type=text name=bo_include_head style='width:80%;' value='<?=$board[bo_include_head]?>'></td>
</tr>
<tr>
    <td><input type=checkbox name=chk_include_tail value=1></td>
    <td class="admin_basic_board_writetd">하단 파일 경로</td>
    <td><input type=text name=bo_include_tail style='width:80%;' value='<?=$board[bo_include_tail]?>'></td>
</tr>


<tr>
    <td><input type=checkbox name=chk_content_head value=1></td>
    <td class="admin_basic_board_writetd">상단 내용</td>
    <!-- <td><textarea name=bo_content_head rows=5 style='width:80%;'><?=$board[bo_content_head] ?></textarea></td> -->
...
<tr>
    ...
    <td class="admin_basic_board_writetd">하단 내용</td>
    <!-- <td><textarea name=bo_content_tail rows=5 style='width:80%;'><?=$board[bo_content_tail] ?></textarea></td> -->
...
<tr>
    ...
    <td class="admin_basic_board_writetd">글쓰기 기본 내용</td>
    <td><textarea name=bo_insert_content rows=5 style='width:80%;'><?=$board[bo_insert_content] ?></textarea></td>
</tr>


<tr>
    <td><input type=checkbox name=chk_use_search value=1></td>
    <td class="admin_basic_board_writetd">전체 검색 사용</td>
...
<tr>
    ...
    <td class="admin_basic_board_writetd">전체 검색 순서</td>
    <td><input type=text name=bo_order_search size=5 value='<?=$board[bo_order_search]?>'> 숫자가 낮은 게시판 부터 검색</td>
</tr>
...
<tr>
    ...
    <td class="admin_basic_board_writetd"><input type=text name='bo_<?=$i?>_subj' value='<?=get_text($board["bo_{$i}_subj"])?>' title='여분필드 <?=$i?> 제목' style='text-align:right;font-weight:bold;'></td>
...
<tr>
    <td colspan='2' class="admin_basic_board_writetd">
        관리자 패스워드
    </td>
    <td>
