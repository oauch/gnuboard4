...
// 기본설정은  board_form-original.php를 참조부탁드리며 
// 사용하는 부분만 살려놓았습니다. 
 -->
...
<tr>
    ...
    <!-- <td><textarea name=bo_content_head rows=3 style='width:80%;'><?=$board[bo_content_head] ?></textarea></td> -->
...
<tr>
    ...
    <!-- <td><textarea name=bo_content_tail rows=3 style='width:80%;'><?=$board[bo_content_tail] ?></textarea></td> -->
...
<p align=center>
    ...
    <input type=button class=admin_black_bt value='목록' onclick="document.location.href='./board_list.php?<?=$qstr?>';">&nbsp;
    <? if ($w == 'u') { ?><input type=button class=admin_black_bt value='복사' onclick="board_copy('<?=$bo_table?>');"><?}?>
</form>
