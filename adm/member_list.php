...
<tr class="admin_basic_board_topln">
	...
	<td><a href="./member_form.php"><b class="admin_org_plus">+추가</b></a></td>
</tr>
...
for ($i=0; $row=sql_fetch_array($result); $i++) {
    ...
    {
        $s_mod = "<a href=\"./member_form.php?$qstr&w=u&mb_id=$row[mb_id]\"><b class='admin_org font8pt'>수정</b></a>";
        //$s_del = "<a href=\"javascript:del('./member_delete.php?$qstr&w=d&mb_id=$row[mb_id]');\">삭제</a>";
        $s_del = "<a href=\"javascript:post_delete('member_delete.php', '$row[mb_id]');\"><b class='font8pt'>삭제</b></a>";
    }
    $s_grp = "<a href='./boardgroupmember_form.php?mb_id=$row[mb_id]'><img src='img/icon_group.gif' border=0 title='그룹' width='1'></a>";
